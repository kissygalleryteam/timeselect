...
kg/timeselect/2.0.0/index
kg/timeselect/2.0.0/mini
 ...
 * @module timeselect
 **/
KISSY.add('kg/timeselect/2.0.0/index',function (S, Node, DOM, Event, Base) {
    var EMPTY = '';
    /**
     * 
     * @class Timeselect
    ...
    S.extend(Timeselect, Base, /** @lends Timeselect.prototype*/{
        ...
        saveTime: function () {
            ...
            //模拟
            //self._setProgress(self.tempSelectedTime, 2.0.0*Math.random());
 ...
 * @module timeselect
 **/
KISSY.add('kg/timeselect/2.0.0/mini',function(S, Component) {
